  ...
  return (
    <>
      <div className="shadow-1 flex justify-between items-center px-4 py-0 sm:px-8 md:px-16 z-50 sticky top-0 bg-white">
        <Link href="/">
          <img
            className="h-12 sm:h-12 p-2 cursor-pointer"
            src="/logo.jpg"
            alt="Logo"
          />
        </Link>
        ...
        <div className="hidden md:flex">
          <ul className="flex gap-4 sm:gap-6">
            ...
            <Link href="/cars">
              <li className="hover:text-primary cursor-pointer">Cars</li>
            </Link>
            <Link href="#search-fliter">
              <li className="hover:text-primary cursor-pointer">Search</li>
            </Link>
            <Link href="/blog/66c6eeef6fd2b5788b909128">
              <li className="hover:text-primary cursor-pointer">About Us</li>
            </Link>
            <Link href="/blog/66c6f093dc2c7f86bdc18469">
      ...
      ></div>
      <div
        className={`fixed top-0 right-0 w-[90%] h-full bg-white shadow-lg z-50 transform transition-transform ${
